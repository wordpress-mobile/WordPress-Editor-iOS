...
@property (nonatomic, strong) IBOutlet UITextField *captionIdField;
...
- (void)viewDidLoad {
    ...
    self.captionIdField.text = self.imageMeta.captionId;
    self.classesField.text = self.imageMeta.classes;
    self.heightField.text = self.imageMeta.height;
    self.linkField.text = [[NSNumber numberWithBool:self.imageMeta.link] stringValue];
...
- (void)updateImageMeta
{
    ...
    self.imageMeta.captionId = self.captionIdField.text;
    self.imageMeta.classes = self.classesField.text;
    self.imageMeta.height = self.heightField.text;
    self.imageMeta.link = [self.linkField.text boolValue];
